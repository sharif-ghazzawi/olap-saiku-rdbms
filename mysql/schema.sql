...
CREATE TABLE `document_fact` (
  ...
  CONSTRAINT `FK_ExtractedLocation_DocumentFact` FOREIGN KEY (extracted_location_id) REFERENCES extracted_location(id),
  CONSTRAINT `FK_ExtractedDate_DocumentFact` FOREIGN KEY (extracted_date_id) REFERENCES full_date(id),
  CONSTRAINT `FK_PublicationDate_DocumentFact` FOREIGN KEY (publication_date_id) REFERENCES full_date(id),
  CONSTRAINT `FK_IngestDate_DocumentFact` FOREIGN KEY (ingest_date_id) REFERENCES full_date(id),
  CONSTRAINT `FK_CollectionDate_DocumentFact` FOREIGN KEY (collection_date_id) REFERENCES full_date(id),
  ...
  CONSTRAINT `FK_DocumentLengthGroup_DocumentFact` FOREIGN KEY (document_length_group_id) REFERENCES document_length_group(id),
...
CREATE TABLE `organization_fact` (
  ...
  CONSTRAINT `FK_ExtractedLocation_OrganizationFact` FOREIGN KEY (extracted_location_id) REFERENCES extracted_location(id),
  CONSTRAINT `FK_ExtractedDate_OrganizationFact` FOREIGN KEY (extracted_date_id) REFERENCES full_date(id),
  CONSTRAINT `FK_PublicationDate_OrganizationFact` FOREIGN KEY (publication_date_id) REFERENCES full_date(id),
  CONSTRAINT `FK_IngestDate_OrganizationFact` FOREIGN KEY (ingest_date_id) REFERENCES full_date(id),
  CONSTRAINT `FK_CollectionDate_OrganizationFact` FOREIGN KEY (collection_date_id) REFERENCES full_date(id),
  ...
  CONSTRAINT `FK_DocumentLengthGroup_OrganizationFact` FOREIGN KEY (document_length_group_id) REFERENCES document_length_group(id),
...
CREATE TABLE `person_fact` (
  ...
  CONSTRAINT `FK_ExtractedLocation_PersonFact` FOREIGN KEY (extracted_location_id) REFERENCES extracted_location(id),
  CONSTRAINT `FK_ExtractedDate_PersonFact` FOREIGN KEY (extracted_date_id) REFERENCES full_date(id),
  CONSTRAINT `FK_PublicationDate_PersonFact` FOREIGN KEY (publication_date_id) REFERENCES full_date(id),
  CONSTRAINT `FK_IngestDate_PersonFact` FOREIGN KEY (ingest_date_id) REFERENCES full_date(id),
  CONSTRAINT `FK_CollectionDate_PersonFact` FOREIGN KEY (collection_date_id) REFERENCES full_date(id),
  ...
  CONSTRAINT `FK_DocumentLengthGroup_PersonFact` FOREIGN KEY (document_length_group_id) REFERENCES document_length_group(id),
...
CREATE TABLE `word_fact` (
  ...
  CONSTRAINT `FK_ExtractedLocation_WordFact` FOREIGN KEY (extracted_location_id) REFERENCES extracted_location(id),
  CONSTRAINT `FK_ExtractedDate_WordFact` FOREIGN KEY (extracted_date_id) REFERENCES full_date(id),
  CONSTRAINT `FK_PublicationDate_WordFact` FOREIGN KEY (publication_date_id) REFERENCES full_date(id),
  CONSTRAINT `FK_IngestDate_WordFact` FOREIGN KEY (ingest_date_id) REFERENCES full_date(id),
  CONSTRAINT `FK_CollectionDate_WordFact` FOREIGN KEY (collection_date_id) REFERENCES full_date(id),
  ...
  CONSTRAINT `FK_DocumentLengthGroup_WordFact` FOREIGN KEY (document_length_group_id) REFERENCES document_length_group(id),
